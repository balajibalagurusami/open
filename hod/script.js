...
function calc() {
    ...
    // PF contributions
    const pfEmployeeAnnual = basic * 0.12;  // deducted from take-home
    const pfEmployerAnnual = basic * 0.12;  // part of CTC, not take-home
    const pfTotal = pfEmployeeAnnual + pfEmployerAnnual;

    // Tax on CTC (employer PF included in CTC)
    ...
    const expenses =
        ...
        Number(document.getElementById("air").value || 0) +
        Number(document.getElementById("commute").value || 0) +
